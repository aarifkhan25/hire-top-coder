      ...
      <Section className="py-28 2xl:py-35">
        ...
        <div className="grid md:grid-cols-4 gap-5">
          {[
            ...
            <div className="text-lg 2xl:text-xl font-semibold leading-snug group-hover:text-primary transition mb-2">{t}</div>
            <div className="text-xs 2xl:text-sm text-foreground/75 font-medium leading-relaxed flex-1 group-hover:text-white">{d}</div>
            </Card>
          ))}
        </div>
      </Section>
        ...
        <div className="space-y-3 w-full grid grid-cols-1 md:grid-cols-2 gap-10 px-20 1xl:px-40">
          {[
            ...
            <Card key={s.w} className="flex gap-6 items-center">
              <div className="text-primary font-sans font-semibold text-[12px] uppercase tracking-[0.15em] w-28 flex-shrink-0">{s.w}</div>
              <div>
                <div className="text-white font-semibold">{s.t}</div>
                <div className="text-foreground/55 text-[13px] font-medium">{s.d}</div>
              </div>
            </Card>
          ))}
        </div>
