  ...
  return (
    < >
      ...
      <Section   className="py-28 2xl:py-35">
        ...
        <div className="grid md:grid-cols-3 gap-3 w-full mt-10">
      ...
      <Section   className="py-28 2xl:py-35">
        ...
        <div className="flex flex-wrap justify-center gap-3 mt-10 max-w-xl mx-auto">
          {["React", "Next.js", "Node.js", "Flutter", "React Native", "Firebase", "AWS", "PostgreSQL", "Stripe", "OpenAI"].map((t) => (
            <span key={t} className="px-4 py-2 text-xs 2xl:text-sm rounded-full border border-white/10  bg-primary/10 transition-colors hover:border-primary font-semibold text-[#F0EDFF]">{t}</span>
          ))}
        </div>
      </Section>
