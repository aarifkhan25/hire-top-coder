...
const projects = [
  { title: "Nebula AI Analytics", category: "AI · Dashboard",   desc: "Realtime insights with predictive intelligence.", img: work1, results: "+312% activation", span: "lg:col-span-2 lg:row-span-2" },
  { title: "Vault Cloud",         category: "SaaS · Website",   desc: "Enterprise security marketing site.",          img: work2, results: "3.4× conversion", span: "" },
  { title: "Halo Banking",        category: "Mobile · Fintech", desc: "Cross-platform mobile banking experience.",    img: work3, results: "1M+ downloads", span: "" },
  { title: "Orbit Commerce",      category: "Web App · Retail", desc: "Headless storefront for global brand.",        img: work4, results: "62% faster LCP", span: "lg:col-span-2" },
  { title: "Pareto Studio",       category: "Branding",          desc: "Identity system for a venture fund.",          img: work5, results: "Awwwards SOTD", span: "" },
  { title: "Meridian Automation", category: "Automation · AI",   desc: "Internal ops automation suite.",               img: work6, results: "−40% ops cost", span: "" },
];
...
const caseStudies = [
  { c: "Vault Cloud", t: "Scaling a security platform to 10,000 enterprise seats", d: "How we redesigned onboarding, cut activation friction and rebuilt the marketing engine.", img: work2 },
  { c: "Nebula AI",   t: "Shipping a category-defining analytics product in 12 weeks", d: "A 6-person pod, an AI-native architecture, and a Series A close in record time.", img: work1 },
];
          ...
          {projects.map((p) => (
            <StaggerItem key={p.title} className={p.span}>
              <TiltCard className="group relative h-full min-h-[280px] rounded-3xl overflow-hidden border border-border/40 hover-glow-card cursor-pointer">
                <Image width={500} height={500}  priority={false}  src={p.img} alt={p.title} loading="lazy"
