...
export default function Page() {
 ...
 <main className="px-4 sm:px-6 lg:px-15 1xl:px-20 2xl:px-25 w-full"  >
      <div className="pt-28 "><Breadcrumb items={[{ label: "Home", to: "/" }, { label: "Hire" }, { label: "UI/UX Designer" }]} /></div>
      <PageHero
        eyebrow="Hire by Role"
        title={<>Hire Vetted <span className="text-primary">UI/UX Designers</span></>}
        sub={<>Designers who ship — not just pretty mockups. Top 3% <br/> across product, brand, and design systems.</>}
      ><div className="mt-10 w-full flex justify-center">
         <div className=" w-[70%]  glass rounded-full p-2 pl-5 flex items-center  gap-2 ring-purple">
      ...
      <Section className="py-28 2xl:py-35">
        ...
        <div className="flex flex-wrap justify-center gap-3 mt-10">
          {["Figma", "Sketch", "Adobe XD", "Framer", "Webflow", "Principle", "ProtoPie"].map((t) => (
            <span key={t} className="px-4 py-2 rounded-full  border border-white/10  bg-primary/10 transition-colors hover:border-primary text-sm font-medium">{t}</span>
          ))}
        </div>
      </Section>
